...
{0pt}{7pt}{1pt}
\newcommand{\sym}{\raisebox{2.5pt}{\centerdot}}
\renewcommand{\labelitemi}{\color{color} \sym}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,LO]{\it Elisa Bortolas \ -- \ Curriculum Vitae }
...
\fancyhead[LE,LO]{\it Elisa Bortolas \ -- \ Curriculum Vitae and Publications List }
